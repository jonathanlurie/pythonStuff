...
def create_3d_texture(width, scale):
	...
	for z in coords:
		for y in coords:
			for x in coords:
				v = snoise3(x * scale - half, y * scale - half, z * scale - half, octaves=8, persistence=0.25)
...
if __name__ == '__main__':
	import sys
	global xrot, yrot, d
	win = pyglet.window.Window(width=1000, height=1000, resizable=True, visible=False,
